...
export const INTERNSHIP_RESUME_TH: InternshipResumeData = {
    ...
    additionalInformation: ['ความสามารถด้านภาษา: Thai (Native), English (Intermediate)'],
    contact: {
        phone: '+66 96 910 7926',
        email: 'anothai.0978452316@gmail.com',
...
export function getInternshipResume(language: ResumeLanguage): InternshipResumeData {
