...
const CustomCard = (props: CustomCardProps) => {
  ...
  if (typeof props.icon === 'string') {
    const IconComponent = (LucideIcons as unknown as Record<string, React.ComponentType>)[props.icon];
    if (IconComponent) {
      ...
      <main className="container mx-auto py-10 px-6 max-w-4xl relative">
        ...
        <DocsBody>
          <article className="prose prose-slate dark:prose-invert max-w-none">
            <Mdx components={{ ...defaultMdxComponents, Card: CustomCard, Mermaid, Quiz, Playground, Tabs, Tab, Callout }} />
          </article>
        </DocsBody>
